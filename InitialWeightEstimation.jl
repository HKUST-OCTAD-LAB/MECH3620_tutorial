...
#> [frontmatter]
#> title = "Initial Weight Estimation"
...
using PlutoUI; TableOfContents(title = "MECH 3620")
...
# ╔═╡ 5863a340-6f4a-11eb-317f-87310d521da3
md"""
...
# ╔═╡ 50a696d0-6f4a-11eb-0bb8-2193f0116a39
md"""
...
# ╔═╡ 277aed11-461f-458b-98e4-d901f7c465ab
# Example computation
...
# ╔═╡ 4e00e6b0-6f54-11eb-0934-8724c686aee0
...
# ╔═╡ 62ac4880-6aa8-11eb-17e2-8f0200fea068
md"### Loiter Segment 2
...
# ╔═╡ e4786b63-64e1-48b6-bf5c-699cb74da8fe
md"One way to evaluate this is to manually evaluate the product of the weight fractions and the expression as follows."

# ╔═╡ 9d5979ca-3d12-45df-a4f9-a246791f4539
Wf_man = 1.06 * (1 - takeoffFF * climbFF * cruise1FF * loiter1FF * cruise2FF * loiter2FF * landingFF)

# ╔═╡ 61a9c3bd-0775-4a0c-823a-30854fd7412d
...
# ╔═╡ d4efe350-6f50-11eb-1a8b-4f5e2f6474bd
...
# ╔═╡ 015db960-edc1-4bf0-9353-eab806882408
...
# ╔═╡ d49855f0-50c5-4957-b22d-271ade48a8c1
...
# ╔═╡ 67ce525e-e66f-4051-8473-d1692e269945
A, B = 0.88, -0.07 # Raymer's coefficients for this aircraft type

# ╔═╡ a2b1cdf9-28be-497d-a23f-892e502d610d
WTO_random = 4800 # kg

# ╔═╡ 4f66de5e-82ed-4b44-a2e4-3a5547bde15b
WeW0 = empty_weight_raymer(WTO_random * g, A, B)

# ╔═╡ 4b497bfd-247d-4255-929c-9c967870e909
md"For demonstration, here are the estimated empty weights for a range of guessed takeoff weights."

# ╔═╡ 17d9d635-ef9e-4915-8de4-c5ea411e6357
WTO_range = 1000:500:10000 # kg

# ╔═╡ e1f00137-1d7f-41ff-b927-29d81b578c29
WeWTO_range = empty_weight_raymer.(WTO_range .* g, A, B) # Broadcasting over range

# ╔═╡ c2e58228-c937-4291-a76a-9f5118dc0fbb
plot(
...
# ╔═╡ ca31e850-664f-11eb-31d1-8b3c06d45227
...
# ╔═╡ a440db20-6dc9-11eb-3976-71fed3025e96
md"We need an initial guess to start the iteration process. Let's try the sum of the payload and crew weights."

# ╔═╡ 149722de-6653-11eb-0dee-3351ec547ef4
W0 = WPL + Wcrew # Initial guess

# ╔═╡ 5dd206d7-ec95-48d9-a0ef-fa8cf60ecd68
...
# ╔═╡ ef1be394-ef78-4738-ac57-1f0e1bcfc5e1
md"We can check the resultant values of the takeoff weights."

# ╔═╡ bbc91560-6dc3-11eb-170d-73036550cea4
...
# ╔═╡ 3d3e1da0-6164-4b37-b31c-f26ebba0b9bb
...
# ╔═╡ 85f74980-1d42-4203-a3e4-f109a94a344a
WTOs

# ╔═╡ e2260a50-6dc9-11eb-1102-4bb9f3362cfd
MTOW_kg = WTOs[end] / g # kg

# ╔═╡ 20d08ef0-6aa1-11eb-0006-fd7cabe833f7
begin
	plot1 = plot(WTOs, 
		label = "", 
		ylabel = "MTOW (N)", 
...
# ╔═╡ 380e0580-6dc5-11eb-0024-c5e47db18e87
alert(md"The empty weight fraction regression ($W_e/W_0$) formula here is **explicitly dependent on the value of $W_0$**. The fuel weight fraction $(W_f / W_0)$ computed from the mission is **not** dependent on $W_0$.")

# ╔═╡ 153eacc0-6aa1-11eb-2d54-d7e15f315773
#= html"""<style>
main {
    max-width: 60%;
}
...
md"""
Roskam: $W_e / W_0 = 10^{(\log_{10} W_0 - C) / D}$
""";

# ╔═╡ cbe0c190-4083-11eb-020e-bbf9f4f7d67a
empty_weight_roskam(WTO, C, D) = 10^(log10(WTO) - C) / D;

# ╔═╡ c348b9fe-6aaa-11eb-3f63-4d42f796482c
warning(md"The coefficients $C$ and $D$ are not the same as $A$ and $B$!");
